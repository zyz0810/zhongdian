  ...
  <div class="app-container">
    <div class="p20 bg_white">
      ...
      <el-table v-loading="listLoading" :data="list" :height="tableHeight" border :header-cell-style="{background:'rgb(244,244,252)',}"
        ...
        <el-table-column label="完成目标" align="center" prop="address"></el-table-column>
        <el-table-column label="完成时间" align="center" prop="time"></el-table-column>
        <el-table-column label="责任科室" align="center" prop="time"></el-table-column>
        <el-table-column label="分管领导" align="center" prop="time"></el-table-column>
        <el-table-column label="备注" align="center" prop="time"></el-table-column>
      </el-table>
